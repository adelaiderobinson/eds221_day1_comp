...
#parsing error- assigned the class based on initial lines, but later it didn't match
...
#takes all column names, and puts them into a case that you specify
```
...
```{r}
#unless you tell it otherwise it will just pull the last graph, but you can specify plot = 
